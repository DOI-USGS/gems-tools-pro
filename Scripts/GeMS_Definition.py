...
unrepresentableDomainDict = {
    ...
    "OrientationConfidenceDegrees": "Positive real number. Value of -9, -99, -999, or -9999 indicates value is unknown.",
    "LocationConfidenceMeters": "Positive real number. Value of -9, -99, or -9999 indicates value is unknown.",
    "NumericAge": "Positive real number. Zero or negative value may indicate non-numeric (i.e., limiting) age.",
    "AgePlusError": "Positive real number. Value of -9, -99, or -9999 indicates value is unknown.",
    "AgeMinusError": "Positive real number. Value of -9, -99, or -9999 indicates value is unknown.",
...
entityDict = {
    ...
    "GenericPoints": "Point locations for unspecified purpose",
    ...
    "GeologicPoints": "Point locations of various geological features",
