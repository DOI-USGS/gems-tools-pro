...
units_dict = term_dict(obj_dict, 'DescriptionOfMapUnits', ['MapUnit', 'Name', 'Fullname', 'DescriptionSourceID'])
geomat_dict = term_dict(obj_dict, 'GeoMaterialDict', ['GeoMaterial', 'Definition'])
gloss_dict = term_dict(obj_dict, 'Glossary', ['Term', 'Definition', 'DefinitionSourceID'])
...
child_nodes = [['idinfo', 0], ['dataqual', 1], ['eainfo', 4], ['distinfo', 5], ['metainfo', 6]]
